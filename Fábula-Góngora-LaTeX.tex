...
\date{\vspace{60pt}\textsc{Con variantes de la redacción primitiva}\\\fontsize{60}{11}\selectfont{\vfill\textbf{\texttt{\LaTeX}}}}
%
\setmainfont{Alt Standard}[RawFeature=lnum]
\setmainlanguage{spanish}
%CONSPECTVS SIGLORVM.
\newcommand{\ch}{\emph{\textbf{Ch}}}
\newcommand{\guno}{\textbf{\emph{G}\textsuperscript{1}}}
...
\footindent[T]{none}
\linenummargin{outer}
\nummarginsep{-25pt}{-60pt}
\thepagelook{downter}
\renewcommand{\lemmaseparatorA}{\textbf{→}}
%
\begin{document}
...
\pagenumbering{Roman}
\setcounter{page}{1}
\section*{\raggedleft\textsc{Testimonios consultados}}
...
%
Para la presentación del texto se modernizaron las grafías y se regula\-rizaron alternancias, a excepción de los siguientes casos:
%
\begin{itemize}[label=--]%
...
%
El «aparato crítico» es negativo. Se reproducen los errores de {\ch} y, a modo de variantes descartadas, todas las lecciones de {\guno}, la redacción primitiva. Los \emph{lemmata} se colocaron tal cual se editaron para el texto crítico.\par
\repage
%
\simplehead{\textsc{Bibliography}}
\section*{\raggedleft\textsc{Bibliografía}}
...
\setcounter{page}{1}
\setmainhead{\emph{\textsc{Fábula de Polifemo y Galatea}}}
...
peinar el \footA{viento}{monte \emph{corr.} {\guno}}, fatigar la selva.\par\poend
%
\begin{center}
	\textbf{II}
\end{center}
...
Y al cuerno, al fin, la cítara suceda.\par\poend
%
\begin{center}
	\textbf{III}
\end{center}
...
tu nombre oirán los términos del mundo.\par\poend
\repage
%
...
mordaça es a una gruta de su boca.\par\poend
%
\begin{center}
	\textbf{V}
\end{center}
...
gimiendo tristes y volando graves.\par\poend
%
\begin{center}
	\textbf{VI}
\end{center}\postart
...
que un silbo junta y un peñasco sella.\par\poend
\repage
%
\begin{center}
	\textbf{VII}
...
que un día era bastón y otro cayado.\par\poend
%
\begin{center}
	\textbf{VIII}
\end{center}
...
surcada aun de los dedos de su mano.\par\poend
%
\begin{center}
	\textbf{IX}
\end{center}
...
pisando la dudosa luz del día.\par\poend
%
\begin{center}
	\textbf{X}
\end{center}
...
del \footA{mejor}{primer {\guno}} mundo, del candor primero.\par\poend
%
\begin{center}
	\textbf{XII}
\end{center}
...
¡tal la música es de Poliphemo!\par\poend
%
\begin{center}
	\textbf{XIII}
\end{center}
...
pavón de Venus es, cisne de Juno.\par\poend 
%
\begin{center}
	\textbf{XIV}
\end{center}
...
pender en oro al nácar de su oreja.\par\poend
%
\begin{center}
	\textbf{XV}
\end{center}
...
en carro de cristal, campos de plata.\par\poend
%
\begin{center}
	\textbf{XVI}
\end{center}
...
tantas flores pisó como él espumas.\par\poend
%
\begin{center}
	\textbf{XVII}
\end{center}\postart
...
delfín, que sigue en agua corza en tierra!\par\poend
%
\begin{center}
	\textbf{XVIII}
\end{center}\postart
...
las provincias de Europa son hormigas.\par\poend
%
\begin{center}
	\textbf{XIX}
\end{center}\postart
...
deidad, aunque sin templo, es Galathea.\par\poend
%
\begin{center}
	\textbf{XX}
\end{center}\postart
...
si artificiosa no, su honesta hija.\par\poend
%
\begin{center}
	\textbf{XXI}
\end{center}\postart
...
el zéfiro no silva, o cruxe el robre.\par\poend
%
\begin{center}
	\textbf{XXII}
\end{center}\postart
...
\footA{el silencio del can siga, y el sueño}{el silençio del can sigan o el sueño {\guno}}!\par\poend
%
\begin{center}
	\textbf{XXIII}
\end{center}\postart
...
por no abrasar con tres soles al día.\par\poend
%
\begin{center}
	\textbf{XXIV}
\end{center}\postart
...
al sonoro cristal, al cristal mudo.\par\poend
%
\begin{center}
	\textbf{XXV}
\end{center}\postart
...
rinden las bacas y fomenta el robre.\par\poend
\repage
%
\begin{center}
	\textbf{XXVI}
...
su néctar vinculó la primavera.\par\poend
%
\begin{center}
	\textbf{XXVII}
\end{center}\postart
...
de frescas sombras, de menuda grama.\par\poend
%
\begin{center}
	\textbf{XXVIII}
\end{center}\postart
...
grillos de nieve fue, plumas de hielo.\par\poend
\repage
%
\begin{center}
	\textbf{XXIX}
...
más discursiva y menos alterada.\par\poend
%
\begin{center}
	\textbf{XXX}
\end{center}\postart
...
el desdén hasta allí de Galathea.\par\poend
%
\begin{center}
	\textbf{XXXI}
\end{center}\postart
...
confuso alcaide más, el verde soto.\par\poend
%
\begin{center}
	\textbf{XXXII}
\end{center}\postart
...
fingiendo sueño al canto garzón halla.\par\poend
%
\begin{center}
	\textbf{XXXIII}
\end{center}\postart
...
que la eminencia abriga de un escollo,\par\poend
%
\begin{center}
	\textbf{XXXIV}
\end{center}\postart
...
con el pincel que le clavó su pecho,\par\poend
%
\begin{center}
	\textbf{XXXV}
\end{center}\postart
...
como duerme la luz, niegan las flores.\par\poend
%
\begin{center}
	\textbf{XXXVI}
\end{center}\postart
...
por apurarle la ponzoña al vaso.\par\poend
%
\begin{center}
	\textbf{XXXVII}
\end{center}\postart
...
sin romper muros, introduce fuego.\par\poend 
%
\begin{center}
	\textbf{XXXVIII}
\end{center}\postart
...
Galathea lo diga, salteada.\par\poend 
%
\begin{center}
	\textbf{XXXIX}
\end{center}\postart
...
trepando troncos y abrazando piedras.\par\poend
%
\begin{center}
	\textbf{XL}
\end{center}\postart
...
--trompas de Amor-- alteran sus oídos.\par\poend
%
\begin{center}
	\textbf{XLI}
\end{center}\postart
...
fugitivo cristal, pomos de nieve.\par\poend
%
\begin{center}
	\textbf{XLII}
\end{center}\postart
...
tálamo de Acis ya y de Galathea.\par\poend
%
\begin{center}
	\textbf{XLIII}
\end{center}\postart
...
linterna es ciega y atalaya muda.\par\poend
%
\begin{center}
	\textbf{XLIV}
\end{center}\postart
...
muerta de amor, y de temor no viva.\par\poend
%
\begin{center}
	\textbf{XLV}
\end{center}\postart
...
¡referidlo, Pïérides, os ruego!\par\poend
%
\begin{center}
	\textbf{XLVI}
\end{center}\postart
...
¡Oh tú, que en dos incluyes las más bellas!\par\poend
%
\begin{center}
	\textbf{XLVII}
\end{center}\postart
...
sin concebir roció, parir perlas.\par\poend
%
\begin{center}
	\textbf{XLVIII}
\end{center}\postart
...
mi voz, por dulce, quando no por mía.\par\poend
%
\begin{center}
	\textbf{XLX}
\end{center}\postart
...
en número a mis bienes son mis males.\par\poend
%
\begin{center}
	\textbf{L}
\end{center}\postart
...
y en ruecas de oros rayos de sol hilan.\par\poend
%
\begin{center}
	\textbf{LI}
\end{center}\postart
...
del perezoso Volga al Indo adusto.\par\poend
%
\begin{center}
	\textbf{LII}
\end{center}\postart
...
escribir mis desdichas con el dedo?\par\poend
%
\begin{center}
	\textbf{LIII}
\end{center}\postart
...
o al cielo humano, o al cíclope celeste.\par\poend
%
\begin{center}
	\textbf{LIV}
\end{center}\postart
...
do halló reparo, si perdió camino.\par\poend
%
\begin{center}
	\textbf{LV}
\end{center}\postart
...
dulcísimas coyundas) mi instrumento,\par\poend
%
\begin{center}
	\textbf{LVI}
\end{center}\postart
...
a las que esta montaña engendra harpías.\par\poend
\repage
%
\begin{center}
	\textbf{LVII}
...
sufrir muros le vio, romper phalanges:\par\poend
%
\begin{center}
	\textbf{LVIII}
\end{center}\postart
...
Venus del mar, Cupido de los montes».\par\poend
%
\begin{center}
	\textbf{LIX}
\end{center}\postart
...
que el muro penetraron de las yedras.\par\poend
%
\begin{center}
	\textbf{LX}
\end{center}\postart
...
que vario sexo unió y un surco abriga.\par\poend
%
\begin{center}
	\textbf{LXI}
\end{center}\postart
...
previene rayo fulminante trompa.\par\poend
%
\begin{center}
	\textbf{LXII}
\end{center}\postart
...
la sangre que exprimió, cristal fue puro.\par\poend
%
\begin{center}
	\textbf{LXIII}
\end{center}\postart
...
yerno lo saludó, lo aclamó río.\par\poend
\enum
\enpage
\end{document}